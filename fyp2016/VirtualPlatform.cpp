...
VirtualPlatform::VirtualPlatform(HardwareInterface* interf) : hwi(interf)
{
}
...
bool VirtualPlatform::initialise() {
...
bool VirtualPlatform::createImage(Visual displayMode) {
...
SDL_Surface* VirtualPlatform::retrieveImage() {
	return image;
}